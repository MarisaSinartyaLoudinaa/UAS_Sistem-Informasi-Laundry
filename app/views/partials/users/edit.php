                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nama_customer"  value="<?php  echo $data['nama_customer']; ?>" type="text" placeholder="Enter Nama Customer"  required="" name="nama_customer"  data-url="api/json/users_nama_customer_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
