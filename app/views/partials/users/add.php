                        ...
                        <form id="users-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("users/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nama_customer">Nama Customer <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nama_customer"  value="<?php  echo $this->set_field_value('nama_customer',""); ?>" type="text" placeholder="Enter Nama Customer"  required="" name="nama_customer"  data-url="api/json/users_nama_customer_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="is_admin">Is Admin <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-is_admin"  value="<?php  echo $this->set_field_value('is_admin',"0"); ?>" type="number" placeholder="Enter Is Admin" step="1"  required="" name="is_admin"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
