                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-jenis_barang"> Jenis Barang</th>
                                                <th  class="td-nama_barang"> Nama Barang</th>
                                                <th  class="td-jenis_layanan"> Jenis Layanan</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("barang/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-jenis_barang">
                                                        <span  data-value="<?php echo $data['jenis_barang']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("barang/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="jenis_barang" 
                                                            data-title="Enter Jenis Barang" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-jenis_layanan">
                                                        <span  data-value="<?php echo $data['jenis_layanan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("barang/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="jenis_layanan" 
                                                            data-title="Enter Jenis Layanan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
