                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="jenis_barang">Jenis Barang <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-jenis_barang"  value="<?php  echo $this->set_field_value('jenis_barang',""); ?>" type="text" placeholder="Enter Jenis Barang"  required="" name="jenis_barang"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="jenis_layanan">Jenis Layanan <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-jenis_layanan"  value="<?php  echo $this->set_field_value('jenis_layanan',""); ?>" type="text" placeholder="Enter Jenis Layanan"  required="" name="jenis_layanan"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
