                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tanggal_masuk"  value="<?php  echo $data['tanggal_masuk']; ?>" type="text" placeholder="Enter Tanggal Masuk"  required="" name="tanggal_masuk"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-tanggal_selesai"  value="<?php  echo $data['tanggal_selesai']; ?>" type="text" placeholder="Enter Tanggal Selesai"  required="" name="tanggal_selesai"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
