                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div class="bg-primary m-2 mb-4">
                            <div class="profile">
                                ...
                                <h1 class="title mt-4"><?php echo $data['nama_customer']; ?></h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                        ...
                                        <div class="tab-pane show active fade" id="AccountPageView" role="tabpanel">
                                            <table class="table table-hover table-borderless table-striped">
                                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <tr  class="td-nama_customer">
                                                        <th class="title"> Nama Customer: </th>
                                                        <td class="value">
                                                            <span  data-value="<?php echo $data['nama_customer']; ?>" 
                                                                data-pk="<?php echo $data['id'] ?>" 
                                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                                data-name="nama_customer" 
                                                                data-title="Enter Nama Customer" 
                                                                data-placement="left" 
                                                                data-toggle="click" 
                                                                data-type="text" 
                                                                data-mode="popover" 
                                                    ...
                                                    <tr  class="td-is_admin">
                                                        <th class="title"> Is Admin: </th>
                                                        <td class="value">
                                                            <span  data-value="<?php echo $data['is_admin']; ?>" 
                                                                data-pk="<?php echo $data['id'] ?>" 
                                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                                data-name="is_admin" 
                                                                data-title="Enter Is Admin" 
                                                                data-placement="left" 
                                                                data-toggle="click" 
                                                                data-type="number" 
                                                                data-mode="popover" 
