                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th class="td-sno">#</th>
                                                <th  class="td-no_nota"> No Nota</th>
                                                <th  class="td-pelanggan_id"> Pelanggan Id</th>
                                                <th  class="td-cabang_id"> Cabang Id</th>
                                                <th  class="td-status_id"> Status Id</th>
                                                <th  class="td-barang_id"> Barang Id</th>
                                                <th  class="td-berat"> Berat</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['no_nota'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <th class="td-sno"><?php echo $counter; ?></th>
                                                    <td class="td-no_nota"><a href="<?php print_link("transaksi/view/$data[no_nota]") ?>"><?php echo $data['no_nota']; ?></a></td>
