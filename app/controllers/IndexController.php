...
class IndexController extends BaseController{
	...
	private function login_user($username , $password_text, $rememberme = false){
		...
		$db->where("nama_customer", $username)->orWhere("email", $username);
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("nama_customer","image","email","email_verified_at","password","is_admin","created_at","updated_at"); //registration fields
