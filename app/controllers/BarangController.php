...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				barang.id LIKE ? OR 
				barang.jenis_barang LIKE ? OR 
				barang.nama_barang LIKE ? OR 
				barang.jenis_layanan LIKE ? OR 
				barang.satuan LIKE ? OR 
				barang.harga LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id","jenis_barang","nama_barang","jenis_layanan","satuan","harga");
			...
			$this->sanitize_array = array(
				'id' => 'sanitize_string',
				'jenis_barang' => 'sanitize_string',
				'nama_barang' => 'sanitize_string',
				'jenis_layanan' => 'sanitize_string',
